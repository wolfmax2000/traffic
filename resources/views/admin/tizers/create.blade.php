...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.tizer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tizers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ext_link') ? 'is-invalid' : '' }}" type="text" name="ext_link" id="ext_link" value="{{ old('ext_link', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cats') ? 'is-invalid' : '' }}" name="cats[]" id="cats" multiple required>
                    ...
                    @foreach($categories as $id => $cat)
                        <option value="{{ $id }}" {{ (in_array($id, old('cats', []))  ) ? 'selected' : '' }}>{{ $cat }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('aprove') ? 'is-invalid' : '' }}" type="number" name="aprove" id="aprove" value="{{ old('aprove') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" name="price" id="price" value="{{ old('price') }}" step="0.01">
                @if($errors->has('price'))
            ...
            <div class="form-group">
                <input type="checkbox" value="1" name="is_razgon" id="iz_razgon" />
