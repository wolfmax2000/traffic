    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.templates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stat_days') ? 'is-invalid' : '' }}" type="text" name="stat_days" id="stat_days" value="{{ old('stat_days', '') }}" required>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('utm_name') ? 'is-invalid' : '' }}" type="text" name="utm_name" id="utm_name" value="{{ old('utm_name', '') }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('utm_value') ? 'is-invalid' : '' }}" type="text" name="utm_value" id="utm_value" value="{{ old('utm_value', '') }}">
            ...
            <div class="form-row">
                <!--div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('tizer_boost_geo') ? 'is-invalid' : '' }}" type="text" name="tizer_boost_geo" id="tizer_boost_geo" value="{{ old('tizer_boost_geo', '') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('tizer_boost_val') ? 'is-invalid' : '' }}" type="text" name="tizer_boost_val" id="tizer_boost_val" value="{{ old('tizer_boost_val', '') }}">
                ...
                <!--div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('news_boost_geo') ? 'is-invalid' : '' }}" type="text" name="news_boost_geo" id="news_boost_geo" value="{{ old('news_boost_geo', '') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('news_boost_val') ? 'is-invalid' : '' }}" type="text" name="news_boost_val" id="news_boost_val" value="{{ old('news_boost_val', '') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control {{ $errors->has('head_script') ? 'is-invalid' : '' }}" name="head_script" id="head_script">{{ old('head_script', '') }}</textarea>
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control {{ $errors->has('body_script') ? 'is-invalid' : '' }}" name="body_script" id="body_script">{{ old('body_script', '') }}</textarea>
